...
with gr.Blocks() as removeBgApplication:
    ...
    def removeBgHuman(input_img):
        ...
        return result[OutputKeys.OUTPUT_IMG]
    with gr.Tab("Background Extraction"):
        with gr.Row():
            with gr.Column():
    ...
    with gr.Tab("Portrait Extraction"):
        with gr.Row():
            ...
            with gr.Column():
                ...
                with gr.Row():
                    removeBgHumanBtn = gr.Button("Submit")
                with gr.Row():
